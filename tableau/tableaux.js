...
tab1.push(0);
//console.log(tab1); pour verifier
...
tab1.pop();
//console.log(tab1.pop()); pour voir écrit sur la console la valeur retiré
...
console.log(tab1[12]);
console.log(tab1);
for ( let i = 0 ; i<12 ; i++){// i<12 cest la meme chose que i<tab1.lenght
    console.log(tab1[i]);
}
// 9) Retirer et stocker dans la variable maVariable le dernier élément du tableau tab1.
let maVariable = tab1.pop();//tab1.pop()est 58 /let maVariable = 58 ça veut dire 58 est dans maVariable du coup stocker dans la variable
